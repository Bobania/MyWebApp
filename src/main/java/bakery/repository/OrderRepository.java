...
/**
 * Репозиторий для управления сущностями Order в базе данных
 */
public class OrderRepository {
    ...
    /**
     * Сохраняет новую сущность Order в базе данных
     *
     * @param order сущность Order для сохранения
     */
    ...
    /**
     * Находит сущность Order по её id
     *
     * @param id, id сущности Order для поиска
     * @return сущность Order с указанным id, или null, если не найдена
     */
    ...
    /**
     * Находит все сущности Order в базе данных
     *
     * @return список всех сущностей Order
     */
    ...
    /**
     * Обновляет существующую сущность Order в базе данных
     *
     * @param order сущность Order для обновления
     */
    ...
    /**
     * Удаляет сущность Order из базы данных по её id
     *
     * @param id id сущности Order для удаления
     */
    ...
    /**
     * Возвращает список id клиентов, связанных с заказом по его id
     *
    ...
    /**
     * Добавляет клиента в заказ по его id
     *
     * @param orderId id заказа
     * @param clientId id клиента для добавления
     */
